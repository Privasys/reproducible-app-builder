...
| `wasmtime` | Wasmtime line (major version) of the target runtime, e.g. `47` or `48`. Optional, defaults to `48`. Selects the builder image `:wasmtime-<line>`; the callback reports it back as `wasmtime_line` with the pinned `builder_image` digest |
...
|-------|----------|-------------------|
| `ghcr.io/privasys/reproducible-app-builder:wasmtime-47` | 47 | `privasys-v0.2.0` |
| `ghcr.io/privasys/reproducible-app-builder:wasmtime-48` (also `:latest`) | 48 | `privasys-v0.3.0` |
